...
"")
        ...
        self.sync_source_label.setGeometry(QtCore.QRect(10, 10, 90, 21))
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(12)
        self.sync_source_label.setFont(font)
        self.sync_source_label.setObjectName("sync_source_label")
        self.sync_auto = QtWidgets.QRadioButton(self.frame)
        self.sync_auto.setGeometry(QtCore.QRect(110, 10, 58, 22))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.sync_auto.sizePolicy().hasHeightForWidth())
        self.sync_auto.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(11)
        self.sync_auto.setFont(font)
        self.sync_auto.setObjectName("sync_auto")
        self.sync_jack = QtWidgets.QRadioButton(self.frame)
        self.sync_jack.setGeometry(QtCore.QRect(110, 50, 54, 22))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.sync_jack.sizePolicy().hasHeightForWidth())
        self.sync_jack.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(11)
        self.sync_jack.setFont(font)
        self.sync_jack.setObjectName("sync_jack")
        self.sync_midi = QtWidgets.QRadioButton(self.frame)
        self.sync_midi.setGeometry(QtCore.QRect(110, 30, 59, 22))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.sync_midi.sizePolicy().hasHeightForWidth())
        self.sync_midi.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("Lato")
        font.setPointSize(11)
        self.sync_midi.setFont(font)
        self.sync_midi.setObjectName("sync_midi")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sync_source_label.setText(_translate("MainWindow", "Sync Source:"))
        self.sync_auto.setText(_translate("MainWindow", "Auto"))
        self.sync_jack.setText(_translate("MainWindow", "Jack"))
        self.sync_midi.setText(_translate("MainWindow", "MIDI"))
