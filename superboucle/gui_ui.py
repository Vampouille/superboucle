...
" }")
        ...
        self.go_midi = QtWidgets.QPushButton(self.frame_in)
        self.go_midi.setGeometry(QtCore.QRect(30, 440, 171, 111))
        self.go_midi.setObjectName("go_midi")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.go_midi.setText(_translate("MainWindow", "Go Midi !"))
