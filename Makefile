...
UI = superboucle/gui_ui.py superboucle/cell_ui.py superboucle/learn_ui.py \
     superboucle/learn_cell_ui.py superboucle/device_manager_ui.py superboucle/new_song_ui.py \
	 superboucle/add_clip_ui.py superboucle/playlist_ui.py superboucle/port_manager_ui.py \
	 superboucle/add_port_ui.py superboucle/scene_manager_ui.py superboucle/add_scene_ui.py \
	 superboucle/edit_clip_ui.py superboucle/set_tempo_ui.py superboucle/edit_port_regexp_ui.py \
	 superboucle/tape_manager_ui.py
